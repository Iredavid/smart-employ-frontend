...
export function CtaSec() {
  return (
    <section
      id="stats"
      className=" container mx-auto py-12 px-4 text-center scroll-mt-28"
    >
      <div className="flex items-center py-12 px-6 flex-col justify-center rounded-2xl bg-indigo-100 shadow-[0_0_5px_rgba(192,192,192,0.5)] ">
        ...
        <div className="border-indigo-200 rounded-md lg:py-20  text-center">
          {/* Stats */}
          <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-2 lg:gap-16 gap-8 text-blue-500">
...
function Stat({ number, title }: { number: number; title: string }) {
  return (
    <div className="flex flex-col items-center">
      <h2 className="lg:text-5xl sm:text-4xl text-3xl font-medium mb-2 w-full h-full">
        <CountUp
          end={number}
          duration={3}
