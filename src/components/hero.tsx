export function Hero() {
  return (
    <div id="home" className="hero bg-gray-100">
      <div className="container h-full flex flex-col mx-auto lg:flex-row sm:flex-col xs:flex-col items-center px-10 2xl:gap-10 pt-20">
        ...
        <div className="lg:w-1/2 h-1/2 md:w-full flex justify-center md:items-center md:p-0 sm:p-5">
          <img
            ...
            src="https://i.ibb.co/rGx9tfvw/At-the-office-amico.png"
            alt=""
          />
        </div>
      </div>
